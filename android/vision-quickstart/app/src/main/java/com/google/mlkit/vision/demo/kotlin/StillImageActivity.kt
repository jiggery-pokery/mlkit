...
//            resizedBitmap
//            val newBitmap = Bitmap.createBitmap(resizedBitmap, 0, 0, resizedBitmap.width - 1, resizedBitmap.height - 1)
//            val p = Paint()
//            val filter = LightingColorFilter(Color.RED, 1)
//            p.colorFilter = filter
//
//            val canvas = Canvas(newBitmap)
//            canvas.drawBitmap(newBitmap,0.0,0.0,p)
